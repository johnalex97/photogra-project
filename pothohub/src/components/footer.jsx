  ...
  return (
    <div class="bg-gray-100 mt-24">
        ...
        <div class="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
            ...
            <div class="p-5">
                <div class="text-sm uppercase text-indigo-600 font-bold">Ayuda</div>
                <a class="my-3 block" href="/#">Centro de ayuda <span class="text-teal-600 text-xs p-1"></span></a><a
                    class="my-3 block" href="/#">Politicas de Privacidad <span class="text-teal-600 text-xs p-1"></span></a>
            </div>
            <div class="p-5">
    ...
    <div class="bg-gray-100 pt-2">
        ...
        max-w-screen-lg items-center">
            <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                ...
                <a href="/#" class="w-6 mx-1">
                    <svg class="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%"
                        ...
                        0.136,0.34c0.068,0.136 0,0.273 -0.136,0.341Z"></path>
                        </g>
                    </svg>
                </a>
                <a href="/#" class="w-6 mx-1">
            ...
            <div class="my-5">© Copyright 2024. Todos los derechos reservados.</div>
        </div>
    </div>
</div>
    );
